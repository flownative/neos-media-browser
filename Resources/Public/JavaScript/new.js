        ...
        $resource.change(function (e) {
            ...
            if (filesize > maximumFileUploadSize) {
                ...
                $(this.form).on('submit.invalidfile', function (e) {
                    ...
                    if (window.Typo3Neos) {
                        message = window.Typo3Neos.I18n.translate('cannotUploadFile', message, 'Flownative.Media.Browser');
        ...
        if (isSafari) {
            $resource.closest('form').on('submit.safari', function (e) {
                if (!$resource.val()) {
                    ...
                    if (window.Typo3Neos) {
                        message = window.Typo3Neos.I18n.translate('noFileSelected', message, 'Flownative.Media.Browser');
                        window.Typo3Neos.Notification.warning(message);
                    } else {
                        alert(message);
                    }
